  ...
  return (
    <>
      <section className="projects py-[8vh] luxhealth relative flex justify-center items-center h-[100vh] w-[100vw] sm:flex-col px-[6vw] bg-[#5dc6ea]">
        <div className="px-[3vw] flex flex-col justify-center items-start sm:items-center w-[80%]">
          <Image
            ...
            priority={true}
          />
          <p className="text-[1rem] pl-[10px] ubuntu text-[#111649] pt-[1.3rem] md:text-[0.9rem] sm:text-[0.8rem] md:pt-[1rem] sm:py-[0.8rem]">
        ...
        <div className="px-[3vw] flex justify-center items-start flex-col sm:items-center max-w-[50%] sm:max-w-[none]">
          <p className="text-[2.5rem] text-[#111649] tracking-wider text-start md:text-[2rem] sm:text-[1.5rem] rubik">
            LuxHealth
          </p>
          <p className="text-[1.3rem] py-[2rem] plex md:text-[1.2rem] sm:text-[1rem] md:py-[1.7rem] sm:py-[1.3rem] text-[#111649]">
      ...
      <section className="projects mazeai relative flex justify-center items-center py-[8vh] h-[100vh] w-[100vw] sm:flex-col px-[6vw] bg-[#76eb84]">
        <div className="px-[3vw] flex justify-center items-start flex-col sm:items-center max-w-[50%] sm:max-w-[none]">
          <p className="text-[2.5rem] text-[#125413] tracking-wider text-start md:text-[2rem] sm:text-[1.5rem] rubik">
            MazeAI
          </p>
          <p className="text-[1.3rem] py-[2rem] plex md:text-[1.2rem] text-[#125413] sm:text-[1rem] md:py-[1.7rem] sm:py-[1.3rem]">
