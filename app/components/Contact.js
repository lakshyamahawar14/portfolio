...
const Contact = () => {
  return (
    <>
      <section className="contact relative overflow-y-hidden flex justify-center items-center pt-[8vh] h-[100vh] w-[100vw] px-[6vw] md:px-[3vw] usm:hidden bg-[#56cae1]">
        <div className="contactCard relative flex justify-center items-center w-[100%] h-[100%] md:h-[80%] mx-[1rem] md:mx-[10px] max-w-[450px] max-h-[70vh] flex-col bg-[transparent] rounded-xl">
          <div className="flex flex-col justify-center items-center m-auto w-[100%]">
            <div className="py-[20px]">
              <p className="text-[#0c3134] text-[1.8rem] rubik font-[800] tracking-wide md:text-[1.7rem] sm:text-[1.3rem] text-center umd:text-[1.2rem]">
          ...
          <div className="w-[100%] h-[100%] md:w-[90%] md:h-[80%] px-[2vw] flex flex-col m-auto">
            <div className="flex flex-col justify-center items-start m-auto w-[100%]">
              <fieldset className="border-[2px] pb-[10px] w-[100%] border-[#0c3134]">
            ...
            <div className="flex flex-col justify-center items-start m-auto w-[100%]">
              <fieldset className="border-[2px] pb-[10px] w-[100%] border-[#0c3134]">
                ...
                <textarea
                  type="text"
                  name="description"
                  className="text-[1rem] caret-[#0c3134] outline-none relative ml-[10px] px-[10px] h-[35px] w-[90%] broder-none border-b-[2px] border-[#0c3134] min-h-[30vh] text-[#0c3134]"
                ></textarea>
              </fieldset>
            </div>
          </div>
      ...
      <section className="contact justify-center overflow-y-hidden items-center pt-[8vh] relative w-[100vw] h-[auto] min-h-[100vh] usm:flex usm:flex-col hidden bg-[#56cae1]">
            ...
            <div className="flex flex-col justify-center items-start m-auto w-[100%]">
              <fieldset className="border-2 pb-[10px] w-[100%] border-[#0c3134]">
                ...
                <textarea
                  type="text"
                  name="description"
                  className="text-[1rem] caret-[#0c3134] outline-none relative ml-[10px] px-[10px] h-[35px] w-[90%] broder-none border-b-[2px] border-[#0c3134] min-h-[20vh] text-[#0c3134]"
                ></textarea>
              </fieldset>
            </div>
            <div className="flex flex-col justify-center items-center m-auto">
